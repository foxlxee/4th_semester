...
namespace lab_3 {
    ...
    internal class Graph {
        ...
        void bfs(int startVertexIndex, bool[] visited, List<int> elements) {
            if(!elements.Contains(startVertexIndex)) elements.Add(startVertexIndex);
            ...
            while (queue.Count != 0) {
                ...
                for (int i = 0; i < neighbors.Count; i++) {
                    ...
                    if (!visited[neighborIndex]) {
                        ...
                        if (!elements.Contains(neighborIndex)) elements.Add(neighborIndex);
                    }
                }
            }
        }
